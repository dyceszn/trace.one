...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    ...
    <div
      ...
      role="group"
      className={cn(
        "group/input-group relative flex h-8 w-full min-w-0 items-center rounded-none border-0 ring-0 transition-colors outline-none " +
          ...
          "[&_[data-slot=input-group-control]:focus]:border-0 [&_[data-slot=input-group-control]:focus]:ring-0",
        className,
      )}
      {...props}
    />
